...
### COCO JSON
- Formato de anotação utilizado para Object Detection e Segmentação.
- Arquivo JSON contendo:
- `images`: lista das imagens com `id` e `file_name`.
- `annotations`: bounding boxes ou máscaras + `category_id`.
- `categories`: classes definidas (ex: "parada").
